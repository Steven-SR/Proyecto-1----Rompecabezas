...
public class Genetico {
    ...
    private static void ejecutarPrueba(int size, int rangoNum) {
        ...
        // Resolver con algoritmo genetico
        ...
        if (solved) {
            ...
            System.out.println("Estado: NO SE ENCONTRO SOLUCION OPTIMA");
            System.out.println("Mejor configuracion encontrada:");
            tablero.printTablero();
        }
    ...
    public static void main(String[] args) {
        System.out.println("╔══════════════════════════════════════════════════════════════════════╗");
        System.out.println("║            ALGORITMO GENETICO - MEDICION EMPIRICA                    ║");
        System.out.println("╚══════════════════════════════════════════════════════════════════════╝");
        ...
        System.out.println("\n");
        System.out.println("═".repeat(70));
        System.out.println("Algoritmo Genetico completado para todos los tamaños.");
        System.out.println("═".repeat(70));
    }
}
